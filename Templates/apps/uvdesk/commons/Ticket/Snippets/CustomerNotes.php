...
namespace Webkul\UVDesk\ExtensionBundle\Extensions\Commons;

use Twig\Environment as TwigEnvironment;
use Symfony\Component\HttpFoundation\RequestStack;
use Webkul\UVDesk\CoreBundle\Extensibles\Tickets\SnippetInterface;

class CustomerNotes implements SnippetInterface
{
    CONST SVG = <<<SVG
...
SVG;
    ...
    public function getTemplate()
    {
        ...
        return $this->twig->render('@UVDeskExtension//customerNotes.html.twig', [
